...
|--------|------|-------------|
| [Módulo 1](https://github.com/DaviSouza78/Projeto-Conexoes-Seguras/tree/main/Modulo1-Sniffing) | Sniffing e Interceptação | `tcpdump`, `iproute2`, `curl` |
| [Módulo 2](https://github.com/DaviSouza78/Projeto-Conexoes-Seguras/blob/main/Modulo2-TLS/Readme.md) | Criptografia Híbrida e TLS | `OpenSSL` |
| [Módulo 3](https://github.com/DaviSouza78/Projeto-Conexoes-Seguras/tree/main/Modulo3-Sessao) | Gestão Segura de Sessões | `Node.js`, `Express.js`, `curl` |
...
- **Relatório Técnico:** [`relatorio.pdf`](https://github.com/DaviSouza78/Projeto-Conexoes-Seguras/blob/main/Relatorio.pdf)
- **Implementações Práticas:** Pasta de cada módulo contém `README.md` com o passo a passo completo
- **Evidências:** Pasta [`evidencias/`](https://github.com/DaviSouza78/Projeto-Conexoes-Seguras/tree/main/evidencias) com capturas de saída de cada experimento
